...
clbr._value=')'
point._value='.'
buttonlist=[zero,one,three,two,four,five,six,seven,eight,nine,point,add,sub,mul,div,opbr,clbr,neg,exp]
...
table.attach(seven,3,4,1,2)
table.attach(eight,1,2,1,2)
table.attach(nine,2,3,1,2)
table.attach(four,3,4,2,3)
table.attach(five,1,2,2,3)
table.attach(six,2,3,2,3)
table.attach(one,3,4,3,4)
table.attach(two,1,2,3,4)
table.attach(three,2,3,3,4)
table.attach(zero,3,4,4,5)
table.attach(point,1,2,4,5)
table.attach(add,0,1,1,2)
table.attach(sub,0,1,2,3)
table.attach(mul,0,1,3,4)
table.attach(div,0,1,4,5)
